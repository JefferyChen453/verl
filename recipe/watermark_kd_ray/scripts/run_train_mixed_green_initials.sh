#!/usr/bin/env bash
# Mixed green + initials + neg KD training.
...
TRAIN_FILE="${TRAIN_FILE:-${PROJECT_ROOT}/verl/data/initials_icw/train_mixed_green5931_initials865_neg1000.parquet}"
...
"${PY}" -m recipe.watermark_kd_ray.main \
    ...
    trainer.experiment_name=mixed_green5931+initials865+neg1000_dualKL_${DATE}
