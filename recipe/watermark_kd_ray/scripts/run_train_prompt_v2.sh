...
python -m recipe.watermark_kd_ray.main \
    ...
    trainer.experiment_name="filter_strength_5.0_5931_bsz_8__0.0green+1.0kl_biased_ref_$(date +%Y%m%d%H%M)"
...
#     data.val_batch_size=128 \
#     watermark.ce_loss_weight=0.0 \
#     watermark.green_loss_weight=0.1 \
#     watermark.green_target_ratio=0.5 \
#     watermark.kl_biased_ref_actor_weight=1.0 \
#     watermark.kl_ref_actor_weight=0.0 \
#     watermark.kl_biased_actor_actor_weight=0.0 \
#     watermark.gradient_accumulation_steps=1 \
...
#     trainer.val_before_train=true \
#     trainer.project_name=watermark-kd-ray \
#     trainer.experiment_name="filter_strength_3.0_5931_bsz_8__0.1green_hinge0.5+1.0kl_biased_ref_$(date +%Y%m%d%H%M)"
...
python -m recipe.watermark_kd_ray.main \
    ...
    trainer.val_before_train=true \
    trainer.project_name=watermark-kd-ray \
    trainer.experiment_name="filter_strength_5.0_5931_bsz_8__0.0green+1.0reverse_kl_biased_ref_$(date +%Y%m%d%H%M)"