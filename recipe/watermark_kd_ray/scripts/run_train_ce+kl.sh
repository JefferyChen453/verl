...
#     trainer.experiment_name="filter_3583_bsz_8__1.0ce+0.5green+0.0kl_ref$(date +%Y%m%d%H%M)"
...
#     trainer.val_before_train=true \
#     trainer.project_name=watermark-kd-ray \
#     trainer.experiment_name="filter_3592_bsz_8__1.0ce+0.5green+0.0kl_ref$(date +%Y%m%d%H%M)"
...
python -m recipe.watermark_kd_ray.main \
    ...
    data.val_batch_size=64 \
    watermark.ce_loss_weight=1.0 \
    watermark.green_loss_weight=0.6 \
    watermark.kl_biased_ref_actor_weight=0.0 \
    ...
    trainer.project_name=watermark-kd-ray \
    trainer.experiment_name="filter_3583_bsz_8__1.0ce+0.6_green+0.2kl_ref$(date +%Y%m%d%H%M)"